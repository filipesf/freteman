...
import iconArrowSimple from '../assets/icons/arrow-simple.svg';
...
const assets = {
  ...
  icon: {
    menu: iconMenu,
    alert: iconAlert,
    arrowFilled: iconArrowFilled,
    arrowOutline: iconArrowOutline,
    arrowSimple: iconArrowSimple,
